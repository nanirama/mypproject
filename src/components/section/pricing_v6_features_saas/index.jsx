...
export default class PricingV6FeaturesSaas extends Component {
  constructor(props) {
    super(props);
    this.oldElement = "";
    this.state = {};
  ...
  render() {
    const sidebar = this.props.data.items.filter((item) => item.is_title);
    ...
    const groupedById = lodash.groupBy(this.props.data.items, "group_key");

    return (
      <div id="featuresListSaaS" style={{ position: "relative", width: "100%" }}>
        <Grid>
          <Row>
            <ColHideMobile md={3}>
